            ...
            <View style={styles.animationHeader}>
                ...
                <View style={{ padding: 10, flexDirection: 'row' }}>
                    <View style={{ width: '70%', alignItems: 'flex-start', justifyContent: 'center' }}>
                        <Text numberOfLines={2} ellipsizeMode='tail' style={{ paddingLeft: 17, color: colors.theme_fg_three, fontSize: f_30, letterSpacing: 1, fontFamily: bold }}>{strings.how_can_we_help_you}</Text>
                    </View>
        ...
        <View style={styles.container}>
            ...
            <Animated.View opacity={headerHeight} style={[styles.header]}>
                ...
                <TouchableOpacity style={{ width: '83%', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: bold }}>{strings.select_the_reason}</Text>
                </TouchableOpacity>
            </Animated.View>
        </View>
    );
