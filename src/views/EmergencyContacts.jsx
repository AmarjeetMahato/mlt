        ...
        return (
            <View style={styles.animationHeader}>
                ...
                <View style={{ padding: 30, alignItems: 'center' }}>
                    <Text numberOfLines={2} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_30, letterSpacing: 1, fontFamily: bold, textAlign: 'center' }}>{strings.setup_emergency_contacts}</Text>
                </View>
            </View>
        )
    }
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <TouchableOpacity onPress={navigate_add_contact.bind(this)} style={{ justifyContent:'center', alignItems:'center', marginTop:'20%' }}>
                    ...
                    <Text numberOfLines={1} style={{ color: colors.text_grey, fontSize: f_s, fontFamily:normal }}>{strings.add_your_contact}</Text>
                </TouchableOpacity>
                }
                {loading == true &&
            ...
            <View style={{ padding:10 }}>
                <TouchableOpacity onPress={ navigate_add_contact.bind(this) } activeOpacity={1} style={{ width: '100%', backgroundColor: colors.btn_color, borderRadius: 10, height: 50, flexDirection: 'row',  alignItems: 'center', justifyContent: 'center' }}>
                    <Text style={{ color: colors.theme_fg_two, fontSize: f_m, color: colors.theme_fg_three, fontFamily: bold }}>{strings.add_contacts}</Text>
                </TouchableOpacity>
            </View>
            ...
            <Animated.View opacity={headerHeight} style={[styles.header]}>
                ...
                <TouchableOpacity activeOpacity={1} style={{ width: '83%', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: bold }}>{strings.emergency_contacts}</Text>
                </TouchableOpacity>
            </Animated.View>
        </View>
    );
