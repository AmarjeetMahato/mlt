    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        <View style={{ paddingLeft: 20, paddingRight: 20, paddingTop: 10, paddingBottom: 10 }}>
          <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_two, fontSize: f_25, fontFamily: bold }}>{strings.payment_methods}</Text>
        </View>
        <View>
          <TouchableOpacity style={{ flexDirection: 'row', borderBottomWidth: 0.2, padding: 20, borderColor: colors.grey }}>
            ...
            <View style={{ width: '75%', alignItems: 'flex-start', justifyContent: 'center' }}>
              <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_two, fontSize: f_s, fontFamily: bold }}>{strings.razorpay}</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity style={{ flexDirection: 'row', borderBottomWidth: 0.5, padding: 20, borderColor: 'grey' }}>
            ...
            <View style={{ margin: '5%' }} />
            <View style={{ width: '75%', alignItems: 'flex-start', justifyContent: 'center' }}>
              <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_two, fontSize: f_s, fontFamily: bold }}>{strings.paypal}</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity style={{ flexDirection: 'row', borderBottomWidth: 0.5, padding: 20, borderColor: 'grey' }}>
            <View style={{ width: '20%', alignItems: 'center', justifyContent: 'center' }}>
