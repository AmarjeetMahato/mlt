    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.header]}>
        <TouchableOpacity activeOpacity={1} onPress={go_back.bind(this)} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
          <Text numberOfLines={1} ellipsizeMode='tail' style={{ paddingLeft: 20, color: colors.theme_fg_two, fontSize: f_25, fontFamily: bold }}>{strings.terms_conditions}</Text>
        </TouchableOpacity>
      ...
      <ScrollView>
        ...
        <View style={{ backgroundColor: colors.theme_bg_three, padding: 10, margin: 10, borderRadius: 10 }}>
          <View style={{ margin: 10 }}>
            <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_two, fontSize: f_l, fontFamily: bold }}>{strings.what_is_lorem_ipsum}</Text>
            <View style={{ margin: 5 }} />
