    ...
    const call_my_bookings = (fl) => {
        ...
        axios({
            ...
            .then(async response => {
                setTimeout(function () {
                    setLoading(false);
                    console.log("data in Trip Details",response.data.result);
        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={[styles.header]}>
                ...
                <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: bold }}>{strings.my_rides}</Text>
                </View>
            </View>
                ...
                >
                    <View style={{ flexDirection: 'row', width: '100%', backgroundColor: colors.theme_bg_three, borderRadius: 10 }}>
                        <TouchableOpacity onPress={change_filter.bind(this, 1)} style={[filter == 1 ? styles.segment_active_bg : styles.segment_inactive_bg]}>
                            <Text style={[filter == 1 ? styles.segment_active_fg : styles.segment_inactive_fg]}>{strings.ongoing}</Text>
                        </TouchableOpacity>
