      ...
      <ScrollView>
        <View style={{ padding: 20 }}>
          <View style={{ alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_m, fontFamily: bold }}>{strings.sarath_kannan}</Text>
          </View>
        </View>
        <View style={{ margin: 10 }} />
        <View style={{ padding: 20 }}>
          <View style={{ alignItems: 'center', justifyContent: 'center', }}>
            <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_l, fontFamily: bold }}>{strings.how_was_your_trip}</Text>
            <View style={{ margin: 5 }} />
            <Text style={{ color: colors.grey, lineHeight: 25, fontSize: f_s, fontFamily: normal, textAlign: 'center' }}>{strings.your_feedback_will_help_improve_driving_experience}</Text>
          </View>
          ...
          <TextInput
            ...
            multiline={true}
            numberOfLines={5}
            placeholder={strings.enter_your_comment}
