...
import { screenHeight, screenWidth, normal, bold, api_url, get_bill, regular, app_name, f_25, f_s, f_xs, f_m } from '../config/Constants';
                ...
                <ScrollView>
                    ...
                    <View style={{ padding: 20 }}>
                        <View style={{ width: '100%' }}>
                            <Text style={{ letterSpacing: 1.5, lineHeight: 40, color: colors.theme_fg_two, fontSize: f_25, fontFamily: regular, textAlign: 'center' }}>{strings.dear} <Text style={{ fontFamily: bold }}>{data.customer.first_name} </Text>{strings.thanks_for_using}{app_name}</Text>
                            <View style={{ margin: 5 }} />
                            <Text style={{ color: colors.grey, fontSize: f_s, fontFamily: regular, textAlign: 'center' }}>{strings.we_hope_you_enjoyed_your_ride}</Text>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ width: '50%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>{strings.rideprice}</Text>
                            </View>
                            <View style={{ width: '50%', alignItems: 'flex-end', justifyContent: 'center' }}>
                        ...
                        <View style={{ flexDirection: 'row', borderTopWidth: 0.5, borderColor: colors.grey, marginTop: 10, paddingTop: 10 }}>
                            <View style={{ width: '50%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>{strings.tip}</Text>
                            </View>
                            <View style={{ width: '50%', alignItems: 'flex-end', justifyContent: 'center' }}>
                    ...
                    <View style={{ padding: 20 }}>
                        <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_m, fontFamily: normal }}>{strings.Booking}{strings.details}</Text>
                        <View style={{ margin: 5 }} />
                    ...
                    {from != 'home' &&
                        <View>
                            <View style={{ borderTopWidth: 1, marginTop: 10, marginBottom: 10, borderColor: colors.theme_fg_two, borderStyle: 'dashed' }} />
                            <View style={{ padding: 20 }}>
                                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_m, fontFamily: normal }}>{strings.needhelp} ?</Text>
                                <View style={{ margin: 5 }} />
                                <Text style={{ color: colors.grey, fontSize: f_xs, fontFamily: regular }}>{strings.feelfree_register_your_complaint_if_you_face_any_struggles_in_your_trips_we_will_help_you_to_rectify_to_give_you_best_satisfaction} </Text>
                                <View style={{ margin: 5 }} />
                                    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                                        ...
                                        <View style={{ margin:5 }}/>
                                            <Text style={{ color: colors.theme_fg_two, fontSize: f_s, color: colors.theme_fg_two, fontFamily: bold }}>{strings.support}</Text>
                                        </TouchableOpacity>
                                    </View>
                            </View>
                        </View>
