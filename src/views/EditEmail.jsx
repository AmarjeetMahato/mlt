    ...
    const call_profile_update = () => {
        ...
        .then(async response => {
            ...
            alt({
                ...
                message: strings.your_email_has_been_updated,
              });
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>{strings.enter_your_email}</Text>
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>{strings.you_need_enter_your_email}</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
