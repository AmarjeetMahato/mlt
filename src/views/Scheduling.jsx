...
const Scheduling = (props) => {
    ...
    const call_my_bookings = (fl) => {
        ...
        axios({
            ...
            .then(async response => {
                setTimeout(function () {
                    setLoading(false);
                    console.log("data coming from call my booking", response.data.result);
    ...
    const call_trip_details = (trip_id) => {
        axios({
            ...
            .then(async response => {
                console.log("Schedule trip data",response.data.result)
        ...
        ({ item, viewableItems }) => {
            ...
            return (
                <Animated.View style={[
                    ...
                    <TouchableOpacity activeOpacity={1}  style={{ alignItems: 'center', borderRadius: 10, padding: 10 }}>
                        <DropShadow
                            style={{
                                width: '95%',
                                marginBottom: 5,
                            ...
                            <View style={{ flexDirection: 'row', flex: 1, backgroundColor: colors.theme_bg_three, padding: 15, borderTopLeftRadius: 10, borderTopRightRadius: 10 }}>
                                ...
                                <View style={{ width: '33%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                    ...
                                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                                        ...
                                        {/* Comment the rating in My rides All Section     @Amarjeet Mahato */}
                                ...
                                {/* Comment the Fare     @Amarjeet Mahato */}
                                ...
                                {/* Comment the distance  @Amarjeet Mahato */}
                                {/* <View style={{ width: '25%', alignItems: 'center', justifyContent: 'center' }}>
                                    <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: normal }}>{strings.distance}</Text>
                                    <View style={{ margin: 3 }} />
                                    <Text style={{ color: colors.theme_fg_two, fontSize: f_s, fontFamily: bold }}>{item.distance}{strings.km}</Text>
                                </View> */}
                            </View>
        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={[styles.header]}>
                ...
                <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: bold }}>{strings.scheduling}</Text>
                </View>
            </View>
            <View style={{ alignItems: 'center', margin: 10 }}>
                ...
                >
                    ...
                    <View style={{ flexDirection: 'row',alignItems:'center',justifyContent:'center', width: '100%', backgroundColor: colors.theme_bg_three, borderRadius: 10 }}>
                        <TouchableOpacity
                            // onPress={() => change_filter(1)}
                            style={{display:'flex',width:'40%', backgroundColor: colors.theme_bg,borderRadius: 10, flexDirection:'row', alignItems:'center', justifyContent:'center', padding:15}}
                        >
                            <Text  style={{display:'flex',fontWeight:'500', color:"#fff",fontSize: 12,flexDirection:'row', alignItems:'center',justifyContent:'center'}}>
                                {strings.weekly}
                            </Text>
                        </TouchableOpacity>
                    </View>
...
const styles = StyleSheet.create({
    ...
    segment_active_bg: { width: '40%', alignItems: 'center', justifyContent: 'center', padding: 15, backgroundColor: colors.theme_bg, borderRadius: 10 },
